...
def save_agent(agent):
    torch.save(agent.actor.state_dict(), osp.join(G.output_dir, "vars_policy.pkl"))
    torch.save(agent.critic_prediction.state_dict(), osp.join(G.output_dir, "vars_baseline.pkl"))
