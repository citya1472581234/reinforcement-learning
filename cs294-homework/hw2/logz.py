...
def save_agent(agent):
    torch.save(agent.policy.state_dict(), osp.join(G.output_dir, "vars_policy.pkl"))
    if agent.nn_baseline:
        torch.save(agent.baseline_prediction.state_dict(), osp.join(G.output_dir, "vars_baseline.pkl"))
